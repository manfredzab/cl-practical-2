...
def align(train, english, chinese, threshold, num_sents):
	...
	sys.stderr.write("Training with Dice's coefficient (gathering counts)...\n")
	...
	sys.stderr.write("Counts gathered.\nCalculating Dice coefficients for each word pair...\n")
	...
	sys.stderr.write("Dice coefficients calculated.\nOutputting aligned pairs...\n")	
	for (f, e) in bitext:
